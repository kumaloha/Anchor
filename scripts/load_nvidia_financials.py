...
INCOME = {
    "FY2022": [
        ...
        ("rd_expense", "Research & Development", 5268),
    ...
    "FY2023": [
        ...
        ("rd_expense", "Research & Development", 7339),
    ...
    "FY2024": [
        ...
        ("rd_expense", "Research & Development", 8675),
    ...
    "FY2025": [
        ...
        ("rd_expense", "Research & Development", 12914),
    ...
    "FY2026": [
        ...
        ("rd_expense", "Research & Development", 18497),
...
CASHFLOW = {
    "FY2022": [
        ("operating_cashflow", "Operating Cash Flow", 9108),
        ("capex", "Capital Expenditures", -976),
        ("free_cashflow", "Free Cash Flow", 8132),
        ("depreciation", "Depreciation & Amortization", 1174),
        ("investing_cashflow", "Investing Cash Flow", -9830),
        ("financing_cashflow", "Financing Cash Flow", 1865),
        ("dividends_paid", "Dividends Paid", -399),
        ("share_buyback", "Share Buybacks", 0),
        ("debt_issued", "Long-Term Debt Issued", 4977),
        ("debt_repaid", "Long-Term Debt Repaid", -1000),
        ("net_cash_change", "Net Cash Flow", 1143),
    ],
    "FY2023": [
        ("operating_cashflow", "Operating Cash Flow", 5641),
        ("capex", "Capital Expenditures", -1833),
        ("free_cashflow", "Free Cash Flow", 3808),
        ("depreciation", "Depreciation & Amortization", 1544),
        ("investing_cashflow", "Investing Cash Flow", 7375),
        ("financing_cashflow", "Financing Cash Flow", -11617),
        ("dividends_paid", "Dividends Paid", -398),
        ("share_buyback", "Share Buybacks", -10039),
        ("debt_issued", "Long-Term Debt Issued", 0),
        ("debt_repaid", "Long-Term Debt Repaid", 0),
        ("net_cash_change", "Net Cash Flow", 1399),
    ],
    "FY2024": [
        ("operating_cashflow", "Operating Cash Flow", 28090),
        ("capex", "Capital Expenditures", -1069),
        ("free_cashflow", "Free Cash Flow", 27021),
        ("depreciation", "Depreciation & Amortization", 1508),
        ("investing_cashflow", "Investing Cash Flow", -10566),
        ("financing_cashflow", "Financing Cash Flow", -13633),
        ("dividends_paid", "Dividends Paid", -395),
        ("share_buyback", "Share Buybacks", -9533),
        ("debt_issued", "Long-Term Debt Issued", 0),
        ("debt_repaid", "Long-Term Debt Repaid", -1250),
        ("net_cash_change", "Net Cash Flow", 3891),
    ],
    "FY2025": [
        ("operating_cashflow", "Operating Cash Flow", 64089),
        ("capex", "Capital Expenditures", -3236),
        ("free_cashflow", "Free Cash Flow", 60853),
        ("depreciation", "Depreciation & Amortization", 1864),
        ("investing_cashflow", "Investing Cash Flow", -20421),
        ("financing_cashflow", "Financing Cash Flow", -42359),
        ("dividends_paid", "Dividends Paid", -834),
        ("share_buyback", "Share Buybacks", -33706),
        ("debt_issued", "Long-Term Debt Issued", 0),
        ("debt_repaid", "Long-Term Debt Repaid", -1250),
        ("net_cash_change", "Net Cash Flow", 1309),
    ],
    "FY2026": [
        ("operating_cashflow", "Operating Cash Flow", 102718),
        ("capex", "Capital Expenditures", -6042),
        ("free_cashflow", "Free Cash Flow", 96676),
        ("depreciation", "Depreciation & Amortization", 2843),
        ("investing_cashflow", "Investing Cash Flow", -52228),
        ("financing_cashflow", "Financing Cash Flow", -48474),
        ("dividends_paid", "Dividends Paid", -974),
        ("share_buyback", "Share Buybacks", -40086),
        ("debt_issued", "Long-Term Debt Issued", 0),
        ("debt_repaid", "Long-Term Debt Repaid", 0),
